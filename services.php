<?php
	...
	$param_keys=array('name', 'address', 'descr', 'contact', 'products', 'schedule', 'marks', 'user_id'); // названия полей в таблице БД
	$param_str=array('Наименование филиала', 'Адрес', 'Описание', 'Контакты', 'Виды услуг', 'Время работы', 'Марки производителей', 'Представитель'); // названия столбцов в таблице для отображения
	$param_ext=array(0, 0, 0, 0, 0, 0, 0, '`users`.`fio`'); // поля для select
